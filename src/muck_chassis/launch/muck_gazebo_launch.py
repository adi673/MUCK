...
def generate_launch_description():
    pkg_share = launch_ros.substitutions.FindPackageShare(package='muck_chassis').find('muck_chassis')
    xacro_file_ebot = os.path.join(pkg_share, 'models/','ebot/', 'muck_description.xacro')
    ...
    start_world = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            os.path.join(get_package_share_directory('muck_chassis'), 'launch', 'no_roof_small_warehouse.launch.py'),
        )
    )
